  ...
  return (
    <dialog ref={dialogRef} aria-labelledby="info-dialog-title" className="info-dialog">
      <div className="info-dialog__content">
        ...
        ) : <div><p>2026-07-23 — 말풍선·하트 외곽선을 매끈하게 다듬고, 책을 세로 비율이 살아 있는 열린 책 모양으로 개선</p><p>2026-07-23 — 선택한 마스크 안에 단어가 배치되도록 모양별 경계를 맞추고, 모든 색상 견본이 보이도록 개선</p><p>2026-07-19 — 첨부 시안에 맞춰 가로형 미리보기, 설정 막대, 단어표 디자인을 개선</p><p>2026-07-19 — GitHub Pages에서도 스타일과 미리보기 자산이 안정적으로 열리도록 배포 경로를 개선</p><p>2026-07-19 — 교사용 워드 클라우드 사이트 첫 제작</p></div>}
      </div>
    </dialog>
  );
}
